...
class BookingCreatedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Booking Received - ' . $booking->spa->name)
            ->greeting('Hello ' . $notifiable->name . '!')
            ->line('Your booking at **' . $booking->spa->name . '** has been received and is pending confirmation.')
            ...
            ->line('We will notify you once the spa owner confirms your booking.');
    }
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => 'Your booking at ' . $this->booking->spa->name . ' has been received and is pending confirmation.',
        ];
    }
}
