...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .form-card { background: #2a2a2a; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.3); padding: 35px 40px; max-width: 600px; border: 1px solid rgba(201,169,97,0.15); }
    ...
    .avatar-info strong { display: block; color: white; font-size: 16px; }
    .avatar-info span { color: rgba(255,255,255,0.6); font-size: 13px; }
