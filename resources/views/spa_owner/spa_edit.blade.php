...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .form-card { background: #2a2a2a; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.3); padding: 35px 40px; max-width: 750px; border: 1px solid rgba(201,169,97,0.15); }
