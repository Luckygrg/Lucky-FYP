...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .slug-hint { font-size: 12px; color: rgba(255,255,255,0.4); margin-top: 5px; font-family: monospace; }
...
<div class="dashboard-container">
    ...
    <div class="main-content">
        <div class="page-header">
            <h1>Edit Category</h1>
            <p>Update details for <strong style="color:#c9a961;">{{ $category->name }}</strong>.</p>
        </div>
